...
**Note:** se você errar uma das suas atualizações, o WA pode desconectá-lo de todos os seus dispositivos e você terá que fazer login novamente.
...
- To get the display picture of some person/group
    ...
    ```
- Para alterar sua imagem de exibição ou a de um grupo
    ``` ts
